...
#define DCIDESC_SYSTEM_IO_DISKREADTIME               _T("Average disk read time (%) for last minute")
#define DCIDESC_SYSTEM_IO_DISKREADTIME_EX            _T("Average disk read time (%) on device {instance} for last minute")
#define DCIDESC_SYSTEM_IO_DISKTIME                   _T("Average disk utilization (%) for last minute")
#define DCIDESC_SYSTEM_IO_DISKTIME_EX                _T("Average disk utilization (%) on device {instance} for last minute")
#define DCIDESC_SYSTEM_IO_DISKWRITETIME              _T("Average disk write time (%) for last minute")
#define DCIDESC_SYSTEM_IO_DISKWRITETIME_EX           _T("Average disk write time (%) on device {instance} for last minute")
...
public:
   ...
   virtual void close(bool success, bool deleteOnFailure = true, bool replaceLocked = false);
