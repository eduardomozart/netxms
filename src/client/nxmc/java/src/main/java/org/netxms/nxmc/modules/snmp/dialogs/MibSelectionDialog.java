...
public class MibSelectionDialog extends Dialog
{
   private I18n i18n = LocalizationHelper.getI18n(MibSelectionDialog.class);
	...
	protected Control createDialogArea(Composite parent)
	{
		...
		oid = WidgetHelper.createLabeledText(dialogArea, SWT.BORDER, 500, i18n.tr("Object identifier (OID)"), "", WidgetHelper.DEFAULT_LAYOUT_DATA); //$NON-NLS-1$
	...
	protected void okPressed()
	{
		...
		if (selectedObject == null)
		{
			...
			if (selectedObject == null)
			{
				MessageDialogHelper.openWarning(getShell(), i18n.tr("Warning"), i18n.tr("Please select MIB object before pressing OK"));
				return;
			}
		}
		saveSettings();
	...
	private void saveSettings()
	{
      ...
      PreferenceStore settings = PreferenceStore.getInstance();
		settings.set("MibSelectionDialog.size", size); //$NON-NLS-1$
	}
	...
	private void doWalk()
	{
		...
		{
			MessageDialogHelper.openError(getShell(), i18n.tr("Error"), i18n.tr("Error parsing SNMP OID"));
		}
	}
