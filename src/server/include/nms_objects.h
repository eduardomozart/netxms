...
public:
   ...
   bool processNewDCValue(const shared_ptr<DCObject>& dco, time_t currTime, const wchar_t *itemValue, const shared_ptr<Table>& tableValue, bool allowPastDataPoints);
