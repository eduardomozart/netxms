...
void Chat::enableVisualizationOutput()
{
   ...
   addMessage("system",
      ...
      "```\n\n"
      "5. DCI CHART - time-series chart rendered directly from DCI data (UI fetches data from server):\n"
      "```netxms-viz\n"
      ...
      "Do NOT call get-historical-data to fetch raw data points just to pass them into a chart visualization - "
      "use dci-chart and let the client fetch the data directly. Only use get-historical-data when you need "
      "to analyze, calculate, or transform the data before presenting it.\n"
      ...
      "\"isComplete\":true,\"hops\":[{\"objectId\":142,\"objectName\":\"...\","
      "\"type\":\"ROUTE\",\"ifIndex\":3,\"nextHop\":\"10.0.1.1\","
      "\"route\":\"10.0.2.0/24\",\"name\":\"eth0\"}]}\n"
      "```\n"
      ...
      "7. MAP - geolocation of objects:\n"
      "```netxms-viz\n"
      "{\"type\":\"map\",\"title\":\"...\","
      "\"center\":[51.505,-0.09],\"zoom\":10,"
      "\"markers\":[{\"lat\":51.505,\"lng\":-0.09,"
      "\"label\":\"London Office\",\"objectId\":123,"
      "\"objectName\":\"london-gw\",\"status\":\"normal\","
      "\"popup\":\"Gateway router\"}]}\n"
      "```\n"
      "Use this when presenting geographic locations of objects. "
      "Fields center and zoom are optional - if omitted, the map auto-fits to marker bounds. "
      "Status values: normal, warning, minor, major, critical (controls marker color). "
      "Fields objectId, objectName, popup are optional.\n\n"
      "8. HEATMAP - time-of-day or categorical intensity grid:\n"
      "```netxms-viz\n"
      "{\"type\":\"heatmap\",\"title\":\"...\","
      "\"rowLabels\":[\"Mon\",\"Tue\",\"Wed\",\"Thu\",\"Fri\",\"Sat\",\"Sun\"],"
      "\"columnLabels\":[\"00\",\"01\",\"02\",...,\"23\"],"
      "\"values\":[[5,12,0,...],[3,8,1,...],...],"
      "\"colorRange\":[\"#ffffff\",\"#dc2626\"],\"valueLabel\":\"events\"}\n"
      "```\n"
      "Use this for time-of-day analysis (hours x days), density patterns, or any 2D grid data. "
      "values is a 2D array [row][col]. colorRange specifies min-to-max color interpolation - "
      "use [\"#ffffff\",\"#dc2626\"] (white-to-red) for errors/problems, "
      "[\"#ffffff\",\"#3b82f6\"] (white-to-blue) for neutral metrics like throughput. "
      "valueLabel is used in tooltips (e.g. \"events\", \"requests\").\n\n"
      "9. SPARKLINE GRID - top-N ranked list with trend sparklines:\n"
      "```netxms-viz\n"
      "{\"type\":\"sparkline-grid\",\"title\":\"Top 10 busiest interfaces\","
      "\"unit\":\"%\",\"items\":["
      "{\"label\":\"Switch-01 :: Gi0/1\",\"value\":94.2,"
      "\"nodeId\":123,\"dciId\":456,\"timeRange\":\"last-1h\"},"
      "{\"label\":\"Router-03 :: Eth0\",\"value\":87.5,"
      "\"nodeId\":789,\"dciId\":101,\"timeRange\":\"last-1h\"}]}\n"
      "```\n"
      "Use this for ranked lists (top-N busiest, highest CPU, etc.). "
      "Items should be pre-sorted (highest value first). "
      "nodeId, dciId, timeRange are optional - when present, the client fetches DCI history "
      "to render a mini sparkline trend chart next to each row. "
      "Use get-metrics to resolve nodeId/dciId for each item. "
      "Omit nodeId/dciId if DCI data is not available - the row will show the value without a sparkline.\n\n"
      "10. TOPOLOGY - interactive network topology graph (UI fetches topology data from server):\n"
      "```netxms-viz\n"
      "{\"type\":\"topology\",\"title\":\"L2 Topology around Switch-01\","
      "\"objectId\":123,\"topologyType\":\"l2\","
      "\"params\":{\"radius\":3,\"useL1Topology\":false}}\n"
      "```\n"
      "Use this when the user asks to see network topology, neighbors, or connectivity around a node. "
      "The client fetches topology data from the server and renders an interactive force-directed graph. "
      "topologyType must be one of: l2 (Layer 2/switch), ip (IP/router), ospf (OSPF domain), "
      "internal (proxy/tunnel relationships). "
      "objectId MUST be a valid node ID obtained from function calls. "
      "params is optional: radius (int, hop count) for l2/ip, useL1Topology (bool) for l2 only.\n\n"
      "RULES:\n"
      ...
      "- PREFER `dci-chart` over fetching data with get-historical-data + regular `chart` when the user "
      "just wants to see/display/plot DCI data without analysis or processing\n"
   );
