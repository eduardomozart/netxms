...
TCHAR LIBNETXMS_EXPORTABLE *NXCPMessageCodeName(uint16_t code, TCHAR *buffer)
{
   static const TCHAR *messageNames[] =
   {
      ...
      _T("CMD_PACKAGE_DEPLOYMENT_JOB_UPDATE"),
      _T("CMD_GET_DATA_COLLECTION_SUMMARY"),
      _T("CMD_REQUEST_AUTH_TOKEN"),
      ...
      _T("CMD_GET_ASSET_MANAGEMENT_SCHEMA"),
      _T("CMD_CREATE_ASSET_ATTRIBUTE"),
      _T("CMD_UPDATE_ASSET_ATTRIBUTE"),
      _T("CMD_DELETE_ASSET_ATTRIBUTE"),
      _T("CMD_SET_ASSET_PROPERTY"),
      ...
      _T("CMD_CLONE_MAP"),
		...
		_T("CMD_GET_VLANS"),
		_T("CMD_GET_SYSTEM_TIME"),
		_T("CMD_SET_SYSTEM_TIME"),
		_T("CMD_CHANGE_ZONE"),
      ...
      _T("CMD_GET_DEVICE_VIEW"),
      _T("CMD_MAP_ELEMENT_UPDATE"),
      _T("CMD_GET_BACKGROUND_TASK_STATE"),
      ...
      _T("CMD_GET_DEVICE_CONFIG_BACKUPS"),
      _T("CMD_GET_DEVICE_CONFIG_BACKUP"),
      _T("CMD_GET_L2_NETWORK_PATH"),
      _T("CMD_GET_CLOUD_CONNECTOR_NAMES"),
   ...
   if ((code >= CMD_LOGIN) && (code <= CMD_MODIFY_AI_DISABLED_LIST))
   {
